...
class ProductController extends Controller
{
     ...
     */
    public function show(Product $product, ProductShowRequest $request): Response|ResponseFactory
    {
        ...
        if (isset($data['colour'])) {
            ...
            dd(Attribute::where('name', 'colour')->attributeValues);

            $product->load([
                'variants.attributeValues.attribute' => function($query) use ($colour) {
                    $query->where('attributeValues.value', $colour);
                },
                'variants.media',
            ]);
            dd($product);
